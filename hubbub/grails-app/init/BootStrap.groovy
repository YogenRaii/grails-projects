import com.eprogrammerz.Post
import com.eprogrammerz.Profile
import com.eprogrammerz.User
...
class BootStrap {
    ...
    private createSampleData() {
        ...
        postsAsList[1].dateCreated = now.updated(year: 2014, month: MAY,date: 14)
